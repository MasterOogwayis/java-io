...
/**
 * @author ZhangShaowei on 2019/9/27 14:51
 **/
public class TempHandler extends SimpleChannelInboundHandler<FullHttpRequest> {

    private final String url;

    public TempHandler(String url) {
        this.url = url;
    }
    ...
    private String sanitizeUri(String uri) {
        ...
        return uri.startsWith(File.separator) ? uri : File.separator + uri;
    }
